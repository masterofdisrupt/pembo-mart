            ...
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="forms-sample" method="POST" action="{{ route('update.blog', $getRecord->id) }}" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="mb-4">
                                ...
                                <select name="blog_category_id"
                                    ...
                                    @foreach($getCategory as $category)
                                        <option value="{{ $category->id }}" {{ old('blog_category_id', $getRecord->blog_category_id) == $category->id ? 'selected' : '' }}>
                                            {{ $category->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="mb-4">
                                ...
                                @if($getRecord->getImage())
                                    <img src="{{ $getRecord->getImage() }}" alt="Blog Image" class="img-fluid mt-2" style="max-width: 200px;">
                                @endif
                                @error('image_name')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="mb-4">
                                ...
                                <textarea 
                                    ...
                                    required>{{ old('short_description', $getRecord->short_description) }}</textarea>
                            ...
                            <div class="mb-4">
                                ...
                                <textarea 
                                    ...
                                    required>{{ old('description', $getRecord->description) }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-4">
                             ...
                             <div class="text-end">
                                <a href="{{ route('blog') }}" class="btn btn-secondary me-2">
