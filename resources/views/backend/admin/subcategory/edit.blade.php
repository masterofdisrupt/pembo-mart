            ...
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="forms-sample" method="POST" action="{{ route('sub.category.update', $getRecord->id) }}">
                            @csrf
                            @method('PUT')
                                    ...
                                    <select class="form-control" name="category_id">
                                        ...
                                        @foreach ($getCategory as $category)
                                            <option value="{{ $category->id }}"
                                                {{ $category->id == $getRecord->category_id ? 'selected' : '' }}>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="name"
                                        placeholder="Enter Sub Category Name" value="{{ old('name', $getRecord->name) }}" required>
                                    @error('name')
                             ...
                             <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="slug"
                                        placeholder="Enter Slug Example URL" value="{{ old('slug', $getRecord) }}" required>
                                    @error('slug')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <a href="{{ route('sub.category') }}" class="btn btn-secondary">Back</a>
                        </form>
