    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-lg-12 stretch-card">
                <div class="card">
                    <div class="card-body">
                        <h6 class="card-title">Search Sub Category</h6>
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between align-items-center flex-wrap">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <a href="{{ route('sub.category.add') }}" class="btn btn-primary">
                                    Add Sub Category
                                </a>
                            </div>
                        </div>
                                        ...
                                        <div data-bs-toggle="tooltip" 
                                            ...
                                            <td>
                                                ...
                                                <a class="dropdown-item"
                                                    href="{{ route('sub.category.edit', $value->id) }}"><svg
                                                    ...
                                                    <form action="{{ route('sub.category.delete', $value->id) }}" 
