                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="forms-sample" method="POST" action="{{ route('upadate.system.setting') }}" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                <label class="col-sm-3 col-form-label">Logo Header<span style="color: red;"></span></label>
                                <div class="col-sm-9">
                                    <input type="file" class="form-control" name="logo_header">
                                    @if (!empty($getRecord->getLogoHeader()))
                                        <img src="{{ $getRecord->getLogoHeader() }}" style="width: 100px;">
                                    @endif
                                </div>
                            </div>

                            <div class="row mb-3">
                                <label class="col-sm-3 col-form-label">Logo Footer<span style="color: red;"></span></label>
                                <div class="col-sm-9">
                                    <input type="file" class="form-control" name="logo_footer">
                                    @if (!empty($getRecord->getLogoFooter()))
                                        <img src="{{ $getRecord->getLogoFooter() }}" style="width: 100px;">
                                    @endif
                                </div>
                            </div>
