    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-lg-12 stretch-card">
                <div class="card">
                    <div class="card-body">
                        <h6 class="card-title">Search Brands</h6>
                        <form action="" method="GET">
                            ...
                            <a href="{{ route('brands') }}" class="btn btn-danger">Reset</a>
                        </form>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between align-items-center flex-wrap">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <a href="{{ route('brands.add') }}" class="btn btn-primary">
                                    Add Brands
                                </a>
                            </div>
                        </div>
                                        ...
                                        <div data-bs-toggle="tooltip" 
                                            ...
                                            <td>
                                                ...
                                                <a class="dropdown-item"
                                                    href="{{ route('brands.edit', $value->id) }}"><svg
                                                    ...
                                                    data-item-name="brand" style="border: none; background: none; cursor: pointer;">
